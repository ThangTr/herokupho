...
var PORT = process.evn.PORT || 9000;
...
mongoose.connect('mongodb+srv://thang:123@cluster0.r2ug3.mongodb.net/thang?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true }, function(err) {
    if (err) {
...
app.get("/Moto", controllerUser.quannam);
